...
import { OptimizedReadingList } from './OptimizedReadingList';
...
export default function ReadingHistoryScreen() {
  ...
  // Get checkin data for calendar
  const { data: checkinData } = useQuery({
    queryKey: ['checkin', 'month', monthKey],
    queryFn: async () => {
  ...
  // Real-time updates for reading data
  useEffect(() => {
